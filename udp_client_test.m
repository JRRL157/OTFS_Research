...
cmd_code = 2;
qam_symbols = qammod(Y.', mod_order, 'InputType', 'bit', 'UnitAveragePower', true);
...
demod_llrs = qamdemod(rx_symbols, mod_order, ...
    'OutputType', 'approxllr', ...
    'NoiseVariance', noise_var, ...
    'UnitAveragePower', true);

data = [cmd_code, 100, length(demod_llrs), demod_llrs.'];
